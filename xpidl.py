...
builtinNames = [
    ...
    Builtin('void', 'void'),
    Builtin('octet', 'number'),
    Builtin('short', 'number', True, True),
    Builtin('long', 'number', True, True),
    Builtin('long long', 'number', True, False),
    Builtin('unsigned short', 'number', False, True),
    Builtin('unsigned long', 'number', False, True),
    Builtin('unsigned long long', 'number', False, False),
    Builtin('float', 'number', True, False),
    Builtin('double', 'number', True, False),
    Builtin('char', 'string', True, False),
    Builtin('string', 'string', False, False),
    Builtin('wchar', 'string', False, False),
    Builtin('wstring', 'string', False, False),
]
